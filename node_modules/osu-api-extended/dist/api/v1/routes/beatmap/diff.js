...
;
const name = (id, obj = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const params = {
        b: id,
        ...
        h: obj.hash,
        since: obj.since,
        mods: (0, index_1.calculate_mods)(obj.mods).number,
        limit: obj.limit,
    };
    if (params.m == -1)
        delete params.m;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/get_beatmaps`, {
        method: 'GET',
        params: params,
    });
    if (data.error)
    ...
    if (data.length == 0)
        return (0, handleErrors_1.handleErrors)(new Error('Beatmap not found'));
