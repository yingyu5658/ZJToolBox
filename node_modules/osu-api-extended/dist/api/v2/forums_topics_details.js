...
exports.forums_topics_details = void 0;
const request_1 = require("../../utility/request");
const handleErrors_1 = require("../../utility/handleErrors");
const forums_topics_details = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    if ((params === null || params === void 0 ? void 0 : params.id) == null) {
        return (0, handleErrors_1.handleErrors)(new Error('Specify topic id'));
    }
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/forums/topics/${params.id}`, {
        method: 'GET',
        params: {
...
exports.forums_topics_details = forums_topics_details;
