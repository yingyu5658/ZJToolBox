...
function forums_details(params, addons) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ;
        const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/forums/${params.id}`, {
            method: 'GET',
            params: {},
            addons,
        });
...
exports.forums_details = forums_details;
;
