...
exports.me_download_quota = void 0;
...
const me_download_quota = (addons) => __awaiter(void 0, void 0, void 0, function* () {
    if (auth_1.credentials.type != 'lazer') {
        return (0, handleErrors_1.handleErrors)(new Error('Login via lazer to use this endpoint'));
    }
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/me/download-quota-check`, {
        method: 'GET',
        addons,
    });
    if (data.error)
...
exports.me_download_quota = me_download_quota;
