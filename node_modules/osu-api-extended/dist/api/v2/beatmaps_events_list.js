...
exports.beatmaps_events_list = void 0;
const request_1 = require("../../utility/request");
const handleErrors_1 = require("../../utility/handleErrors");
const beatmaps_events_list = (obj, addons) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.beatmaps_events_list = beatmaps_events_list;
