...
const chat_messages = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/chat/channels/${params.channel_id}/messages`, {
        method: 'GET',
        params,
        addons,
    });
