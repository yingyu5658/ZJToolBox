...
exports.rooms_leaderboard = void 0;
...
const rooms_leaderboard = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/rooms/${params.id}/leaderboard`, {
        method: 'GET',
        params: { limit: params === null || params === void 0 ? void 0 : params.limit },
        addons,
    });
    if (data.error)
...
exports.rooms_leaderboard = rooms_leaderboard;
