...
const chat_details = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    if ((params === null || params === void 0 ? void 0 : params.channel_id) == null) {
        return (0, handleErrors_1.handleErrors)(new Error(`Specify channel id`));
    }
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/chat/channels/${params.channel_id}`, {
        method: 'GET',
        addons,
    });
    if (data.error)
...
exports.chat_details = chat_details;
