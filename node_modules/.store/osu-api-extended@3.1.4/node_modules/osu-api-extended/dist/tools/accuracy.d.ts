 ...
 * ```
 */
export declare function calculate_accuracy(hits: Hits, max_hits: MaxHits, mode: GamemodeEnum | string | number, lazer: boolean): Response;
export declare function calculate_accuracy(hits: Hits, mode: GamemodeEnum | string | number): Response;
export {};
