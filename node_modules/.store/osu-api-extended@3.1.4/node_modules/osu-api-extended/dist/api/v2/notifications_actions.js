...
const notifications_actions = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    const object = {};
    ...
    switch (params === null || params === void 0 ? void 0 : params.type) {
        case 'mark_as_read':
            ...
            if (!Array.isArray(params.notifications) && !Array.isArray(params.identities)) {
                return (0, handleErrors_1.handleErrors)(new Error(`Missing on of parameters`));
            }
            ;
            // params.ids.forEach((r, index) => object[`identities[${index}][id]`] = r);
            if (Array.isArray(params === null || params === void 0 ? void 0 : params.notifications)) {
                object['notifications'] = params.notifications;
            }
            ;
            if (Array.isArray(params === null || params === void 0 ? void 0 : params.identities)) {
