...
type Response<T extends params['type']> = T extends 'difficulty' ? beatmaps_details_difficulty_response & IError : T extends 'set' ? beatmaps_details_set_response & IError : IError;
