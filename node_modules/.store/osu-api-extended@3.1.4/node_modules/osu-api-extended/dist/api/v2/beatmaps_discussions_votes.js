...
exports.beatmaps_discussions_votes = void 0;
const handleErrors_1 = require("../../utility/handleErrors");
const request_1 = require("../../utility/request");
const beatmaps_discussions_votes = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/beatmapsets/discussions/votes`, {
        method: 'GET',
        params,
        addons
    });
...
exports.beatmaps_discussions_votes = beatmaps_discussions_votes;
