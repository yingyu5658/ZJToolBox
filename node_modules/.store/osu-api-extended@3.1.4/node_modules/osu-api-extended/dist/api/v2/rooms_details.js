...
const rooms_details = (params, addons) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ;
    const data = yield (0, request_1.request)(`https://osu.ppy.sh/api/v2/rooms/${params.id}`, {
        method: 'GET',
        addons,
    });
    if (data.error)
...
exports.rooms_details = rooms_details;
